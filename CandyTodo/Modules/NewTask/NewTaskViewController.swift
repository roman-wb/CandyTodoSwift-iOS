...
final class NewTaskViewController: ViewController<NewTaskView> {
...
struct NewTaskViewRepresentable: UIViewRepresentable {
...
struct NewTaskViewControllerPreview: PreviewProvider {
    static var previews: some View {
        Group {
            ForEach(PreviewDevices, id: \.self) { name in
                NewTaskViewRepresentable()
